...
./walletd -w walletA.wallet -p yourpass --rpc-password test --daemon-port 17890 --bind-port 8070
./walletd -w walletB.wallet -p yourpass --rpc-password test --daemon-port 17890 --bind-port 8071
