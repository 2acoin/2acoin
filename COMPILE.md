...
-   `MSBuild 2ACoin.sln /p:Configuration=Release /p:PlatformToolset=v141 /m` or `MSBuild src\cli.vcxproj /p:Configuration=Release /p:PlatformToolset=v141 /m`
...
-   `MSBuild 2ACoin.sln /p:Configuration=Release /p:Platform=Win32 /p:PlatformToolset=v141 /m`
...
[^ Return To Top](#compiling-2acoin)
