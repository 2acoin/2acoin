...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        if (o_benchmark)
        {
            ...
            BENCHMARK(cn_armor_slow_hash_v0, o_iterations_long);
            BENCHMARK(cn_armor_slow_hash_v1, o_iterations_long);
            BENCHMARK(cn_armor_slow_hash_v2, o_iterations_long);

            BENCHMARK(cn_armor_lite_slow_hash_v0, o_iterations_long);
            BENCHMARK(cn_armor_lite_slow_hash_v1, o_iterations_long);
            BENCHMARK(cn_armor_lite_slow_hash_v2, o_iterations_long);
        }
    }
