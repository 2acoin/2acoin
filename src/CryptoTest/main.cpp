...
const std::string CN_ARMOR_SLOW_HASH_V0 = "546c3f1badd7c1232c7a3b88cdb013f7f611b7bd3d1d2463540fccbd12997982";
const std::string CN_ARMOR_SLOW_HASH_V1 = "29e7831780a0ab930e0fe3b965f30e8a44d9b3f9ad2241d67cfbfea3ed62a64e";
const std::string CN_ARMOR_SLOW_HASH_V2 = "fc67dfccb5fc90d7855ae903361eabd76f1e40a22a72ad3ef2d6ad27b5a60ce5";

const std::string CN_ARMOR_LITE_SLOW_HASH_V0 = "5e1891a15d5d85c09baf4a3bbe33675cfa3f77229c8ad66c01779e590528d6d3";
const std::string CN_ARMOR_LITE_SLOW_HASH_V1 = "ae7f864a7a2f2b07dcef253581e60a014972b9655a152341cb989164761c180a";
const std::string CN_ARMOR_LITE_SLOW_HASH_V2 = "b2172ec9466e1aee70ec8572a14c233ee354582bcb93f869d429744de5726a26";
...
int main(int argc, char** argv) {
  ...
  try {
    ...
    if (rawData.size() >= 43)
    {
      ...
      cn_armor_slow_hash_v0(rawData.data(), rawData.size(), hash);
      std::cout << "cn_armor_slow_hash_v0: " << Common::toHex(&hash, sizeof(Hash)) << std::endl;
      assert(CompareHashes(hash, CN_ARMOR_SLOW_HASH_V0));

      cn_armor_slow_hash_v1(rawData.data(), rawData.size(), hash);
      std::cout << "cn_armor_slow_hash_v1: " << Common::toHex(&hash, sizeof(Hash)) << std::endl;
      assert(CompareHashes(hash, CN_ARMOR_SLOW_HASH_V1));

      cn_armor_slow_hash_v2(rawData.data(), rawData.size(), hash);
      std::cout << "cn_armor_slow_hash_v2: " << Common::toHex(&hash, sizeof(Hash)) << std::endl;
      assert(CompareHashes(hash, CN_ARMOR_SLOW_HASH_V2));

      std::cout << std::endl;

      cn_armor_lite_slow_hash_v0(rawData.data(), rawData.size(), hash);
      std::cout << "cn_armor_lite_slow_hash_v0: " << Common::toHex(&hash, sizeof(Hash)) << std::endl;
      assert(CompareHashes(hash, CN_ARMOR_LITE_SLOW_HASH_V0));

      cn_armor_lite_slow_hash_v1(rawData.data(), rawData.size(), hash);
      std::cout << "cn_armor_lite_slow_hash_v1: " << Common::toHex(&hash, sizeof(Hash)) << std::endl;
      assert(CompareHashes(hash, CN_ARMOR_LITE_SLOW_HASH_V1));

      cn_armor_lite_slow_hash_v2(rawData.data(), rawData.size(), hash);
      std::cout << "cn_armor_lite_slow_hash_v2: " << Common::toHex(&hash, sizeof(Hash)) << std::endl;
      assert(CompareHashes(hash, CN_ARMOR_LITE_SLOW_HASH_V2));
    ...
    if (o_benchmark)
    {
      ...
      elapsedTime = std::chrono::high_resolution_clock::now() - startTimer;
      std::cout << "cn_armor_slow_hash_v0: " << (o_iterations_long / std::chrono::duration_cast<std::chrono::seconds>(elapsedTime).count()) << " H/s\n";
      ...
      if (rawData.size() >= 43)
      {
        ...
        elapsedTime = std::chrono::high_resolution_clock::now() - startTimer;
        std::cout << "cn_armor_slow_hash_v1: " << (o_iterations_long / std::chrono::duration_cast<std::chrono::seconds>(elapsedTime).count()) << " H/s\n";
        ...
        elapsedTime = std::chrono::high_resolution_clock::now() - startTimer;
        std::cout << "cn_armor_slow_hash_v2: " << (o_iterations_long / std::chrono::duration_cast<std::chrono::seconds>(elapsedTime).count()) << " H/s\n";
      }
      ...
      elapsedTime = std::chrono::high_resolution_clock::now() - startTimer;
      std::cout << "cn_armor_lite_slow_hash_v0: " << (o_iterations_long / std::chrono::duration_cast<std::chrono::seconds>(elapsedTime).count()) << " H/s\n";
      ...
      if (rawData.size() >= 43)
      {
        ...
        elapsedTime = std::chrono::high_resolution_clock::now() - startTimer;
        std::cout << "cn_armor_lite_slow_hash_v1: " << (o_iterations_long / std::chrono::duration_cast<std::chrono::seconds>(elapsedTime).count()) << " H/s\n";
        ...
        elapsedTime = std::chrono::high_resolution_clock::now() - startTimer;
        std::cout << "cn_armor_lite_slow_hash_v2: " << (o_iterations_long / std::chrono::duration_cast<std::chrono::seconds>(elapsedTime).count()) << " H/s\n";
      }
    }
  }
