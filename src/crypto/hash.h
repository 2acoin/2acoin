...
// Standard CryptoNight Armor
#define CN_ARMOR_PAGE_SIZE             262144
#define CN_ARMOR_SCRATCHPAD            262144
#define CN_ARMOR_ITERATIONS            131072
...
#include "hash-ops.h"
  ...
  */
  ...
  // Standard CryptoNight Armor
  inline void cn_armor_slow_hash_v0(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 0, 0, 0, CN_ARMOR_PAGE_SIZE, CN_ARMOR_SCRATCHPAD, CN_ARMOR_ITERATIONS);
  }

  inline void cn_armor_slow_hash_v1(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 0, 1, 0, CN_ARMOR_PAGE_SIZE, CN_ARMOR_SCRATCHPAD, CN_ARMOR_ITERATIONS);
  }

  inline void cn_armor_slow_hash_v2(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 0, 2, 0, CN_ARMOR_PAGE_SIZE, CN_ARMOR_SCRATCHPAD, CN_ARMOR_ITERATIONS);
  }

  // Standard CryptoNight Armor Lite
  inline void cn_armor_lite_slow_hash_v0(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 1, 0, 0, CN_ARMOR_PAGE_SIZE, CN_ARMOR_SCRATCHPAD, CN_ARMOR_ITERATIONS);
  }

  inline void cn_armor_lite_slow_hash_v1(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 1, 1, 0, CN_ARMOR_PAGE_SIZE, CN_ARMOR_SCRATCHPAD, CN_ARMOR_ITERATIONS);
  }

  inline void cn_armor_lite_slow_hash_v2(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 1, 2, 0, CN_ARMOR_PAGE_SIZE, CN_ARMOR_SCRATCHPAD, CN_ARMOR_ITERATIONS);
  }
